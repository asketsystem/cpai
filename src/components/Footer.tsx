  ...
  return (
    <footer className="bg-gray-900 text-gray-200 py-8 mt-16">
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="font-bold text-lg tracking-wide">Contextually Personal AI</div>
        <div className="text-sm">&copy; {new Date().getFullYear()} Franck Asket. All rights reserved.</div>
